...
const MaritalStatus=["Single","Never Married","Married","Informal/Living Together","Separated","Divorced","Widowed"]
const StudentStatus=["Yes","No"]
const EducationalLevel=["None","JHS/MSLC","SHS/O'Level","A'Level","HND/Other Diploma","NVTI","Degree","2nd Degree and Higher","Doctorate and Higher"]
const EmploymentStatus=["Employed","Unemployed","SelfEmployed","Civil_Employed","Private","Unpaid_Worker","Retired"]
